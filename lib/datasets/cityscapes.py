...
if __name__ == "__main__":
    ...
    # dataset._init_co_ocurrence_df()
    # dataset._init_occurence_class_proportions()
    dataset._init_pixel_class_proportions()
    print("break_point")

    # Figure 5.1.8
    # dataset._co_occurences_df.to_csv(
    #     "/home/nickbarry/Documents/MsC-DS/Data_Science_Research_Project/Coresets/Repositories/HRNet-Semantic-Segmentation-Coreset/analysis/plot_csv/section_5/figure_5_1_8_train.csv"
    # )

    # Figfure 5.1.5
    dataset._pixel_df.to_csv(
        "/home/nickbarry/Documents/MsC-DS/Data_Science_Research_Project/Coresets/Repositories/HRNet-Semantic-Segmentation-Coreset/analysis/plot_csv/section_5/figure_5_1_5_val.csv"
    )

    # Figure 5.1.2
    # df = pd.concat([dataset._pixel_df, dataset._occurence_df], axis=1)
    # df = df.set_axis(["pixel-wise", "occurence"], axis=1)
    # df.to_csv(
    #     "/home/nickbarry/Documents/MsC-DS/Data_Science_Research_Project/Coresets/Repositories/HRNet-Semantic-Segmentation-Coreset/analysis/plot_csv/section_5/figure_5_1_2_train.csv"
    # )
